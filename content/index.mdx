...
description: "Welcome to 3-month Scratch curriculum"
---

Welcome to 3-month Scratch curriculum, a Gatsby.js theme by [Code Bushi](https://codebushi.com/gatsby-starters-and-themes/). Quickly and easily create documentation for anything using MDX or Markdown.
