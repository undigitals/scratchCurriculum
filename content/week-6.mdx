...
there will be a message `YOU ARE A WINNER`. However if the boy 👦 touches the `Maze Line` then the boy will .
...
Untill you press `Next Stage` next stage of the game should not start. When click the `Next Stage` next stage of the game will
start.

Draw your next stage more complicated (do not make it easy).
